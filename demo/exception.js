...
function my_listener(request, response) {
  switch (count++) {
    case 0:
      ...
      response.write('\nRunning NodeReport exception demo... ' +
        'refresh page to cause exception (application will terminate)');
      response.end();
      break;
    default:
      throw new UserException('*** exception.js: exception thrown ' +
        'from my_listener()');
  }
}
...
console.log('exception.js: Go to http://<machine>:8080/ ' +
